                ...
                <div className="inline-footer">
                    ...
                    <div className="partners-container">
                        <div className="layer-box">
                            <div className="layer poker"></div>
                            <div className="layer casino"></div>
                        </div>
                        <div className="partners-box">
                            <div className="base layer20"></div>
                            <div className="base layer17"></div>
                            <div className="base layer28"></div>
                            <div className="base layer5"></div>
                            <div className="base layer19"></div>
                            <div className="base layer9"></div>
                            <div className="base layer22"></div>
                            <div className="base layer21"></div>
                            <div className="base layer7"></div>
                        </div>
                        <div className="partners-box">
                            <div className="base layer27"></div>
                            <div className="base layer26"></div>
                            <div className="base layer12"></div>
                            <div className="base layer11"></div>
                            <div className="base layer16"></div>
                            <div className="base layer23"></div>
                            <div className="base layer25"></div>
                            <div className="base layer18"></div>
                            <div className="base layer7"></div>
                        </div>
                    </div>
